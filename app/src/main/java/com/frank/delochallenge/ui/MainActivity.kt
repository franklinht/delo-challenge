...
import com.frank.delochallenge.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun showLoading() {
        if (!binding.mainBody.progressBar.isShown)
            binding.mainBody.progressBar.visibility = View.VISIBLE
    }
